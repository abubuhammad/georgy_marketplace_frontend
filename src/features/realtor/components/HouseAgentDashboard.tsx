...
interface HouseAgentDashboardProps {
...
export const HouseAgentDashboard: React.FC<HouseAgentDashboardProps> = ({ professional }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Agency Properties</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Rental Properties</CardTitle>
            <Home className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.rentalProperties}</div>
            <p className="text-xs text-muted-foreground">
              Managed rentals
            </p>
          </CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Agency Rating</CardTitle>
          ...
          {viewings.length === 0 ? (
            <Card>
              <CardContent className="text-center py-8">
                ...
                <p className="text-gray-600">Viewings will appear here when customers schedule them.</p>
              </CardContent>
            </Card>
          ) : (
        ...
        <TabsContent value="clients" className="space-y-4">
          ...
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-gray-600">Manage your clients and their property requirements.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
